...
(function() {
  var AccumulatorView, AddressOutOfBoundsError, Button, Command, CommandListItemView, CommandListView, Commands, ContainerView, ControlsView, Events, Instruction, Interpreter, KeyboardView, Memory, MonitorView, NotExecutableError, NotStorableError, PeripheralsView, Rsc, Session, SteppingInterpreter, StorageLocation, Utils, root,
...
>>>>>>> Stashed changes
  ...
  CommandListItemView = (function() {
    ...
    CommandListItemView.prototype.onChanged = function(callback) {
      return this.onChangedCallback = callback;
    };
