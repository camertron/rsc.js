...
(function() {
  var Command, CommandListItemView, CommandListView, Commands, ContainerView, Instruction, Interpreter, Memory, Rsc, Session, StorageLocation, root,
  ...
  Instructions.LDA = (function(superClass) {
    ...
    LDA.prototype.execute = function(session, memory) {
  ...
  Instructions.LDC = (function(superClass) {
    ...
    LDC.prototype.execute = function(session, memory) {
  ...
  Instructions.STA = (function(superClass) {
    ...
    STA.prototype.execute = function(session, memory) {
  ...
  Instructions.INP = (function(superClass) {
    ...
    INP.prototype.execute = function(session, memory) {
      return session.incrementProgramCounter();
    };
  ...
  Instructions.OUT = (function(superClass) {
    ...
    OUT.prototype.execute = function(session, memory) {
      return session.incrementProgramCounter();
    };
  ...
  Instructions.ADC = (function(superClass) {
    ...
    ADC.prototype.execute = function(session, memory) {
      session.accumulator += this.command.arg1;
      return session.incrementProgramCounter();
    };
  ...
  Instructions.ADD = (function(superClass) {
    ...
    ADD.prototype.execute = function(session, memory) {
      session.accumulator += this.getLocation(memory).value;
      return session.incrementProgramCounter();
    };
  ...
  Instructions.SUB = (function(superClass) {
    ...
    SUB.prototype.execute = function(session, memory) {
      session.accumulator -= this.getLocation(memory).value;
      return session.incrementProgramCounter();
    };
  ...
  Instructions.MUL = (function(superClass) {
    ...
    MUL.prototype.execute = function(session, memory) {
      session.accumulator *= this.getLocation(memory).value;
      return session.incrementProgramCounter();
    };
  ...
  Instructions.DIV = (function(superClass) {
    ...
    DIV.prototype.execute = function(session, memory) {
      session.accumulator /= this.getLocation(memory).value;
      return session.incrementProgramCounter();
    };
  ...
  Instructions.BRU = (function(superClass) {
    ...
    BRU.prototype.execute = function(session, memory) {
  ...
  Instructions.BPA = (function(superClass) {
    ...
    BPA.prototype.execute = function(session, memory) {
  ...
  Instructions.BNA = (function(superClass) {
    ...
    BNA.prototype.execute = function(session, memory) {
      if (session.accumulator < 0) {
        return session.programCounter = this.command.arg1;
      } else {
        return session.incrementProgramCounter();
  ...
  Instructions.BZA = (function(superClass) {
    ...
    BZA.prototype.execute = function(session, memory) {
      if (session.accumulator === 0) {
        return session.programCounter = this.command.arg1;
      } else {
        return session.incrementProgramCounter();
  ...
  Instructions.STP = (function(superClass) {
    ...
    STP.prototype.execute = function(session, memory) {
  ...
  Interpreter = (function() {
    ...
    Interpreter.prototype.interpret = function(commands) {
      ...
      while (session.shouldContinue()) {
        ...
        results.push(currentInstruction.execute(session, memory));
      }
      return results;
    };
  ...
  Command = (function() {
    ...
    Command.prototype.checkArgNumericality = function() {
      if (this.arity() > 0) {
        if (!isNaN(parseFloat(this.arg1)) && isFinite(this.arg1)) {
          return true;
        } else {
  ...
  CommandListItemView = (function() {
      ...
      this.inputField.keydown((function(_this) {
        return function(e) {
          if (_this.indicatesNextFieldHighlight(e)) {
            return _this.fireIfDefined('onHighlightNextFieldCallback');
          } else if (_this.indicatesPreviousFieldHighlight(e)) {
            return _this.fireIfDefined('onHighlightPreviousFieldCallback');
          }
        };
      })(this));
    }
    ...
    CommandListItemView.prototype.validate = function() {
      ...
      return this.fireIfDefined('onValidateFinishedCallback');
    };
    ...
    CommandListItemView.prototype.fireIfDefined = function(callbackName) {
  ...
  CommandListView = (function() {
    ...
    function CommandListView(model1, options) {
      ...
      commandList = $('.commands', this.elem);
  ...
  ContainerView = (function() {
    ...
    function ContainerView(options) {
      ...
      this.elem.append(this.commandList.elem);
